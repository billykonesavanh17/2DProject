...
public class PokemonPanel extends JPanel
{
	...
	private void setupTable()
	{
		...
		baseLayout.putConstraint(SpringLayout.NORTH, rowField, 59, SpringLayout.SOUTH, pokemonTable);
	...
	private void setupLayout()
	{
		...
		baseLayout.putConstraint(SpringLayout.WEST, columnField, 65, SpringLayout.EAST, rowField);
